...
@section('Content')
    ...
    <section class="shop-background site-banner jarallax pb-0" style="min-height:100px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <img src="{{asset("Admin/dist/img/web/Brands/$brand->Logo")}}" class="Brand-Logo" alt="{{$brand->Brand}}">
                    <div class="breadcrumbs">
                    <span class="item">
                        <a href="{{route('Shop.index')}}" style="color: #d1d1d1;">{{ __('messages.Home')}} /</a>
                    </span>
                        <span class="item text-black">{{$brand->Brand}}</span>
                    </div>
                </div>
            </div>
