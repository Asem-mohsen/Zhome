...
@section('Content')
    ...
    <section>
        <div class="container-shop" id="shop-background">
            <div class="background-image" style="background-image: url({{ asset('UI/Imgs/website/Shop/AlexaImage2.jpg') }})">
            </div>
                ...
                @foreach ($categories as $category)
                    <div class="category-shop slide">
                        <a href="{{ route('Shop.Filter.category', $category->ID) }}">
                            <img src="{{ asset("Admin/dist/img/web/Categories/$category->MainImage") }}"
    ...
    <section id="Boxes">
        ...
        <div class="container">
            <div class="More-boxes">
                ...
                <div class="box hoverhere box-2"
                    style="background-image:url({{ asset('UI/Imgs/website/Shop/AlexaImage2.jpg') }})">
                ...
                <div class="box hoverhere box-3"
                    style="background-image:url({{ asset('UI/Imgs/website/Shop/Escritorio.jpg') }})">
                    <div class="overlay-button" style="width: 85%;">
                        <div class="Info-bundle">
                            <h3>{{ ucfirst(strtolower($bundle->Name)) }}</h3>
                            <p>{{ ucfirst(strtolower($bundle->brand->Brand)) }}</p>
                ...
                <div class="box box-4"
                    style="background-image:url({{ asset('UI/Imgs/website/Shop/LightZhome.jpg') }});flex: 0.6;">
                    <p>{{ __('messages.FindYourPerfect') }}</p>
                    <a class="Button" href="{{ route('Tools.index') }}">{{ __('messages.GetYourDesignButton') }}</a>
                </div>
                <div class="box hoverhere box-5"
                    style="background-image:url({{ asset('UI/Imgs/website/Shop/james-mcdonald-74nIYjsOY88-unsplash.jpg') }})">
                    <div class="overlay-button" style="width: 85%;">
                        <div class="Info-bundle">
                            <h3>{{ ucfirst(strtolower($bundle->Name)) }}</h3>
                            <p>{{ ucfirst(strtolower($bundle->brand->Brand)) }}</p>
        ...
        <section>
            <div class="container">
                <div class="category-Name mt-5">
                    ...
                    <a href="{{ route('Shop.index') }}">{{ __('messages.DiscoverMore') }}<i
            ...
            <section>
                <div class="boxes-shop SubCategory-OnlineShop">
                    <div class="category-Name">
                        ...
                        <a href="{{ route('Shop.Filter.category', $category2->ID) }}">{{ __('messages.DiscoverMore') }}<i
                                class="fa fa-arrow-right ml-2"></i></a>
                    </div>
                        ...
                        <div class="Subs mt-3">
                            @foreach ($category2->subcategories as $subcategory)
                                <a class="ToTheSubPage" href="{{ route('Shop.Filter.subcategory', $subcategory->ID) }}">
                                    <div class="box-shop SubCategory-OnlineShop-Circled"
                                        style="background-image: url({{ asset("Admin/dist/img/web/Categories/SubCategory/$subcategory->image") }})">
                                    </div>
                                    <p>
                                        @if (App::getLocale() == 'ar')
            ...
            <div class="Bundles Images-Home">
                @foreach ($bundles as $bundle)
                    <div class="Bundle-Shop Image-One">
                        <img src="{{ asset("Admin/dist/img/web/Products/MainImage/$bundle->MainImage") }}"
                            class="BigWidth" alt="{{ $bundle->Name }}">
            ...
            <section>
                <div class="boxes-shop SubCategory-OnlineShop">
                    <div class="category-Name">
                        ...
                        <a href="{{ route('Shop.Filter.category', $category->ID) }}">{{ __('messages.DiscoverMore') }}<i
                                class="fa fa-arrow-right ml-2"></i></a>
                    </div>
    ...
    <section>
        <div class="Fixed-bundle item slider-one__slider-1"
            style="background-image: url({{ asset('UI/Imgs/website/Shop/bence-boros-anapPhJFRhM-unsplash.jpg') }})">
            <div class="bottom-slider">
                <a href="{{ route('Shop.FilterIndex') }}"
                    class="thm-btn slider-one__btn">{{ __('messages.ExploreBundles') }}</a>
        ...
        <div class="container mt-5 pt-3">
            ...
            <section>
                <div class="Category-Product mt-4 justify-content-between">
                    ...
                    <a href="{{ route('Shop.Filter.brand', $brand->ID) }}">{{ __('messages.DiscoverMore') }}<i
                            class="fa fa-arrow-right ml-2"></i></a>
                </div>
            ...
            <div class="Cards-contact mt-5 pt-4">
                <div class="card-contact-left align-items-center">
                    <a href="{{ route('Tools.index') }}">
                        <img src="{{ asset('UI/Imgs/website/Shop/r-architecture-T6d96Qrb5MY-unsplash2.png') }}"
                            class="ProposalProduct" alt="Design Your Home">
                    </a>
                    <div class="ToolOnlineShop">
                        <h3>{{ __('messages.ToolOnlineShop') }}</h3>
                        <div>
                            <a href="{{ route('Tools.index') }}" class="cta ShopNowButton" id="BuildHomeCta">
                                <svg xmlns="http://www.w3.org/2000/svg" id="HomeIcon" height="15" width="17"
                                    viewBox="0 0 576 512">
                                    <path transform="translate(30)" id="Path_10"
