...
@section('Content')
    ...
    <form action="{{ route('Shipping.estimations.update' , $estimation->id) }}" method="post">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <p class="mb-0">Edit Products Estimation Delivery Details</p>
                            <button class="btn btn-primary btn-sm ms-auto m-2">edit</button>
                        </div>
                    </div>
                    <div class="card-body">
                        <p class="text-uppercase text-sm">Products Delivery</p>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" id="estimated_delivery_date" name="estimated_delivery_date" value="{{ old('estimated_delivery_date', $estimation->estimated_delivery_date ?? '') }}">
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="estimation_details" class="form-control-label">Estimation Details</label>
                                    <textarea class="form-control" id="estimation_details" name="estimation_details">{{$estimation->estimation_details ?? ''}}</textarea>
                                </div>
