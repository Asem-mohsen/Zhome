<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('index')}}" class="brand-link">
        <img src="{{ asset('Admin/dist/img/web/Logo/Icon.png') }}" alt="Zhome Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('Platform.index')}}" class="nav-link {{ request()->routeIs('Platform.index') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Platforms</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('Orders.ShopOrders.index')}}" class="nav-link {{ request()->routeIs('Orders.ShopOrders.index') ? 'active' : '' }}">
                                <i class="nav-icon fa-solid fa-shop"></i>
                                <p>Shop</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('Orders.ToolsOrders.index')}}" class="nav-link {{ request()->routeIs('Orders.ToolsOrder.index') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('Sales.Promocode.index')}}" class="nav-link {{ request()->routeIs('Sales.Promocode.index') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Promocodes</p>
                            </a>
                        </li>
                ...
                {{-- Subscribers --}}
                <li class="nav-item">
                    <a href="{{ route('Subscribers.index')}}" class="nav-link {{ request()->routeIs('Subscribers.index') ? 'active' : '' }}">
